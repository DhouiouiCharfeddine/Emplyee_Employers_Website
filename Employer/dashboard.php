...
{
    echo "Entrer un nouveau mot de passe";
}
}
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #0083ff4d;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <h2 class="navbar-brand"><?php echo $ennom ?></h2>
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link" href="#" id="dashboard-link">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" id="list-job-link">Liste offre</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" id="add-job-link">Ajouter Offre</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#" id="list-app-link">Liste application</a>
        </li>   
       <li class="nav-item">
...
<form method="post" action="dashboard.php">
  ...
  <div class="mb-2">
    <label required for="password" class="form-label">Nouveau Mot de passe</label>
  ...
  <div class="d-grid gap-2 col-6 mx-auto">
    ...
    margin-left: 30%;
    margin-top: 5%;" type="submit" class="btn btn-primary" name = "update-profile">Sauvegarder</button>
  </div>
</form>
...
<script>
    $(document).ready(function () {
        ...
        $("#add-job-link").click(function (e) {
            e.preventDefault();
            $("#shown-content").load("ajout.php");
        });

        // List job offre link
        $("#list-job-link").click(function (e) {
            e.preventDefault();
            $("#shown-content").load("listeoffre.php", function () {
                $(".view-app").click(function (e) {
                    console.log();
                    var applicationId = $(this).data().applicationId;
                    e.preventDefault();
                    $("#shown-content").load("demandeurpossible.php?id=" + $(this).data().applicationId, function () {
                        sortTable(2);
                    });
                });
        ...
        $("#list-app-link").click(function (e) {
            e.preventDefault();
            $("#shown-content").load("listeapplication.php");
        });
