...
$result10 = $link->query("SELECT * FROM employeur_offre WHERE code_registre_commerce = ".$user_id);
    ...
    <?php
        ...
        echo "<th>Voir s'il y a des demandeurs possible</th>";
        echo " </tr>";
    ...
    <?php
        while ($row = $result->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><a style="background-color: #d72222;" href="dashboard.php?delete_id=<?php echo $row['code_offre_emploi']; ?>">Supprimer</a></td>
                </td>
                
                <td> <a style="background-color: #1a69c3;" href="#" id="view-app" class="view-app" data-application-id="<?php echo $row['code_offre_emploi']; ?>">Clicker</a></td>
            </tr>
            <?php
        }
    }}
