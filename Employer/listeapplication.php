...
if ($result->num_rows > 0) {
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="#" class="job-application-view-cv" data-toggle="modal" data-target="#cvModal">CV</a></td>
      <td>
        <form method="GET" action="dashboard.php" class="job-application-actions">
          ...
          <button type="submit" name="accept" value="<?php echo $job_offer_id; ?>"
            class="btn btn-success job-application-action-accept">Accepter</button>
          <button type="submit" name="reject" value="<?php echo $job_offer_id; ?>"
            class="btn btn-danger job-application-action-reject">Rejeter</button>
        </form>
      </td>
    </tr>
