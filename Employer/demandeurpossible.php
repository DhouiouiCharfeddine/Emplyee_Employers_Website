...
while ($row1 = $result->fetch_assoc()) {
    ...
    if (!$stmt) {
        ...
        $cv = "../demandeur/cv/" . $row1['cv'];
            echo '<br>';
        echo "<tr>";
        echo "<td>" . $row1['prenom']. " ".$row1['nom'] . "</td>";
        echo "<td>" . $row1['email'] . "</td>";
        echo "<td>" . $score . "</td>";
        echo '<td><p class="job-application-cv mb-1"> <a href="#" class="job-application-view-cv" data-toggle="modal" data-target="#cvModal' . $counter . '" id="view-cv">Voir CV</a></p></td>';
        echo '<td>
    <!-- Modal -->
    <div class="modal fade" id="cvModal' . $counter . '" tabindex="-1" role="dialog" aria-labelledby="cvModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
             <div class="modal-header"> 
                <h5 class="modal-title" id="cvModalLabel">' . $row1['prenom']. " ".$row1['nom'] .' CV</h5>
