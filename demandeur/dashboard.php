...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <h2 class="navbar-brand"><?php echo $user_id ?></h2>
...
<script>
    $(document).ready(function () {
        ...
        $("#resume-link").click(function (e) {
            e.preventDefault();
            var cv_id = '<?php echo $_SESSION["username"]; ?>';
            $("#shown-content").load("cv.php?cv_id=" + cv_id);
        });
        ...
        $("#list-job-link").click(function (e) {
            e.preventDefault();
            var cv_id = '<?php echo $_SESSION["username"]; ?>';
            $("#shown-content").load("listeoffre.php?cv_id=" + cv_id, function () {
                // Execute JS function after loading listeoffre.php
                sortTable(7);
            });
        });
        ...
        $("#list-app-link").click(function (e) {
            e.preventDefault();
            var cv_id = '<?php echo $_SESSION["username"]; ?>';
            $("#shown-content").load("listeapplication.php?cv_id=" + cv_id);
        });
    });
