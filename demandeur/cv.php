...
<head>
    ...
    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/XvoAfKtfbY0M5U1" crossorigin="anonymous"></script>
...
<form action="dashboard.php" method="post" enctype="multipart/form-data">
  ...
  <fieldset>
    <legend class="mb-3">Cursus et compétences</legend>
    ...
    <div class="row mb-3">
      <div class="col-md-6">
        ...
        [
          ...
          echo '<select name="competence[]" multiple size="' . 10 . '" class="form-select">';
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="number" name="Experience" id="experience" placeholder="Année d'expérience" size="30" maxlength="40" value="<?php echo $fetch['nombre_annee_experience']; ?>" class="form-control">
          </div>
          <div class="mb-3">
      ...
      <div class="row justify-content-end">
        <div class="col-md-2">
          <button type="submit" class="btn btn-success w-100" name="update_resume">Mettre à jour</button>
        </div>
        <div class="col-md-2">
          <a href="dashboard.php" class="btn btn-secondary w-100">Retour</a>
        </div>
      </div>
